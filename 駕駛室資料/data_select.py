...
# --- 3. 定義資料集 ---
    ...
    # ('2026-01-01 12:00:00', '2026-01-01 13:30:00', 0),#冷媒洩漏10%(改)
    # ('2026-01-01 14:00:00', '2026-01-01 15:30:00', 0),#冷媒洩漏20%(改)
...
source_time_periods = [
    ...
    ('2025-04-11 11:33:00', '2025-04-11 12:03:00', 0),#蒸發盤管阻塞23%
    ('2025-04-11 12:05:00', '2025-04-11 13:35:00', 0),#正常資料常溫34度
    ('2026-01-01 14:00:00', '2026-01-01 15:30:00', 1),#冷媒洩漏20%(改)
]
...
test_time_periods = [
    ('2025-04-14 09:00:00', '2025-04-14 10:00:00', 0),#正常資料低溫24度
    ('2026-01-01 12:00:00', '2026-01-01 13:30:00', 1),#冷媒洩漏10%(改)
]
