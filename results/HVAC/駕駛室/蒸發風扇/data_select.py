...
# --- 3. 定義資料集 ---
    ...
    # ('2026-01-01 06:00:00', '2026-01-01 06:30:00',0),#加熱器故障
    # ('2026-01-01 06:30:00', '2026-01-01 07:00:00',0),#加熱器故障
...
source_time_periods = [
    ...
    ('2026-01-01 01:00:00', '2026-01-01 01:30:00',0),#壓縮機故障30%
    ('2026-01-01 03:00:00', '2026-01-01 03:30:00',0),#冷凝風扇電流上升30%
    ('2026-01-01 05:00:00', '2026-01-01 05:30:00',1),#蒸發風扇電流上升30%
]
...
target_time_periods = [
    ...
    ('2026-01-01 00:30:00', '2026-01-01 01:00:00',0),#壓縮機故障20%
    ('2026-01-01 02:30:00', '2026-01-01 03:00:00',0),#冷凝風扇電流上升20%
    ('2026-01-01 04:30:00', '2026-01-01 05:00:00',1),#蒸發風扇電流上升20%
]
...
test_time_periods = [
    ...
    ('2026-01-01 00:00:00', '2026-01-01 00:30:00',0),#壓縮機故障10%
    ('2026-01-01 02:00:00', '2026-01-01 02:30:00',0),#冷凝風扇電流上升10%
    ('2026-01-01 04:00:00', '2026-01-01 04:30:00',1),#蒸發風扇電流上升10%
]
