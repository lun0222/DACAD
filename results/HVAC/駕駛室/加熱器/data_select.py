...
# --- 1. CSV 檔案名稱 ---
# (已更新為您提供的路徑)
csv_file_name = 'D:/DACAD/駕駛室資料/cab_data.csv'
...
# --- 3. 定義資料集 ---
    ...
    # ('2025-04-11 12:05:00', '2025-04-11 13:35:00',0),#正常資料常溫34度
    # ('2025-04-11 13:45:00', '2025-04-11 14:15:00',0),#蒸發風扇電流90%
    # ('2025-04-11 14:19:00', '2025-04-11 14:49:00',0),#蒸發風扇電流80%
    # ('2025-04-11 14:52:00', '2025-04-11 15:22:00',0),#蒸發風扇電流70%
    # ('2025-04-11 15:46:00', '2025-04-11 16:16:00',0),#正常資料高溫42.7度
    # ('2025-04-14 09:00:00', '2025-04-14 10:00:00',0),#正常資料低溫24度
    # ('2025-04-14 10:49:00', '2025-04-14 11:45:00',0),#加熱器運轉
    # ('2025-04-14 13:25:00', '2025-04-14 14:25:00',0),#冷媒洩漏10%
    # ('2025-04-14 14:50:00', '2025-04-14 15:50:00',0),#冷媒洩漏20%
    # ('2026-01-01 00:00:00', '2026-01-01 01:30:00',0),#壓縮機故障10%
    # ('2026-01-01 01:30:00', '2026-01-01 03:00:00',0),#壓縮機故障20%
    # ('2026-01-01 03:00:00', '2026-01-01 04:30:00',0),#壓縮機故障30%
    # ('2026-01-01 05:00:00', '2026-01-01 06:30:00',0),#冷凝風扇電流上升10%
    # ('2026-01-01 06:30:00', '2026-01-01 08:00:00',0),#冷凝風扇電流上升20%
    # ('2026-01-01 08:00:00', '2026-01-01 09:30:00',0),#冷凝風扇電流上升30%
    # ('2026-01-01 10:00:00', '2026-01-01 11:30:00',0),#蒸發風扇電流上升10%
    # ('2026-01-01 11:30:00', '2026-01-01 13:00:00',0),#蒸發風扇電流上升20%
    # ('2026-01-01 13:00:00', '2026-01-01 14:30:00',0),#蒸發風扇電流上升30%
    # ('2026-01-01 15:00:00', '2026-01-01 15:56:00',0),#加熱器故障10%
    # ('2026-01-01 15:56:00', '2026-01-01 16:52:00',0),#加熱器故障20%
    # ('2026-01-01 16:52:00', '2026-01-01 17:48:00',0),#加熱器故障30%


source_time_periods = [
    ('2025-04-14 10:45:00', '2025-04-14 11:15:00',0),#加熱器運轉
    ('2026-01-01 06:00:00', '2026-01-01 06:20:00',1),#加熱器故障10%
]

target_time_periods = [
    ('2025-04-14 11:15:00', '2025-04-14 11:45:00',0),#加熱器運轉
]

test_time_periods = [
    ('2025-04-14 10:45:00', '2025-04-14 11:15:00',0),#加熱器運轉
    ('2026-01-01 06:20:00', '2026-01-01 06:40:00',1),#加熱器故障20%
    ('2026-01-01 06:40:00', '2026-01-01 07:00:00',1),#加熱器故障30%
]
