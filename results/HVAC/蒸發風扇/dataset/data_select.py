...
source_time_periods = [
    ...
    ('2026-01-01 00:30:00', '2026-01-01 01:00:00',0),#壓縮機故障20%
    ('2026-01-01 01:00:00', '2026-01-01 01:30:00',0),#壓縮機故障30%
    ('2026-01-01 06:00:00', '2026-01-01 06:30:00',1),#蒸發風扇電流上升10%
]
...
target_time_periods = [
    ...
    ('2026-01-01 12:00:00', '2026-01-01 13:30:00',0),#冷媒洩漏10%(改)
    ('2026-01-01 14:00:00', '2026-01-01 15:30:00',0),#冷媒洩漏20%(改)
    ('2026-01-01 07:00:00', '2026-01-01 07:30:00',1),#蒸發風扇電流上升30%
]

test_time_periods = [
    ('2025-04-14 09:00:00', '2025-04-14 10:00:00',0),#正常資料低溫24度
    ('2026-01-01 06:30:00', '2026-01-01 07:00:00',1),#蒸發風扇電流上升20%
]
